...
# data
data_path_water <- "inputs/rehoboth_water_check_support.csv"
...
df_testing_data_water <- df_tool_data_water %>% 
  filter(today < as_date("2024-08-27")) %>% 
...
# output the log
write_csv(x = df_combined_checks_water, file = paste0("inputs/combined_checks_rehoboth_water.csv"), na = "")

# building -------------------------------------------------------------------

# data
data_path_building <- "inputs/rehoboth_building_check_support.csv"
...
# output the log
write_csv(x = df_combined_checks_building, file = paste0("inputs/combined_checks_rehoboth_building.csv"), na = "")

# environmental -------------------------------------------------------------------

# data
data_path_environmental <- "inputs/rehoboth_environmental_check_support.csv"
...
# output the log
write_csv(x = df_combined_checks_environmental, file = paste0("inputs/combined_checks_rehoboth_environmental.csv"), na = "")
