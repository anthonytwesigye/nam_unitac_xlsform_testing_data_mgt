...
# cleaned
loc_data_water_cleaned <- "inputs/clean_rehoboth_water.xlsx"
...
# cleaned
loc_data_building_cleaned <- "inputs/clean_rehoboth_building.xlsx"
...
# cleaned
loc_data_environmental_cleaned <- "inputs/clean_rehoboth_environmental.xlsx"
